package com.intecap.tarea6.auth;
...
public class ConfigSeguridad extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/tarea6/fabricantes").permitAll() //permitAll: permite a todos los usuarios acceder a la ruta
